...
// 2. จำนวนลูกค้าที่แตกต่างกัน มีใครบ้าง แต่ละคนซื้อไปยอดรวมกันเท่าไหร่ กี่เครื่อง
// customer, unitPrice - (unitPrice * discount), count

// //////////////// Version 1 ////////////////

// const arr = sales.reduce((acc, idObj) => {
//   const cusName = idObj.customer;
//   const cusPrice = idObj.product.unitPrice;
//   const discountedPrice = +(cusPrice - cusPrice * idObj.discount);
...
//     acc[cusName].push(discountedPrice);
//   } else {
//     acc[cusName].push(cusPrice);
//   }
...
//   const cusName = idObj.customer;
//   const cusPrice = idObj.product.unitPrice;
//   const finalPrice = +(cusPrice - cusPrice * (idObj.discount || 0));

//   if (!acc[cusName]) {
//     acc[cusName] = 0;
//   }

//   acc[cusName] += finalPrice;
